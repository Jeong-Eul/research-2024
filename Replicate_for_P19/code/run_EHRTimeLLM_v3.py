...
from model import TimeLLM, EHRTime_LLM, EHRTime_LLM_v3
...
if __name__ == '__main__':
    ...
    parser.add_argument('--patch_len', type=int, default=6, help='dimension of fcn')
    parser.add_argument('--stride', type=int, default=2, help='dimension of fcn')
    ...
    for ii in range(args.itr):
        ...
        if args.model == 'TimeLLM':
            ...
            model = EHRTime_LLM_v3.Model(args).float()
