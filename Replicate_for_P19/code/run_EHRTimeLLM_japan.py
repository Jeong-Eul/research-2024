...
from model import TimeLLM, EHRTime_LLM, EHRTime_LLM_japan, EHRTime_LLM_v5
...
if __name__ == '__main__':
    ...
    for ii in range(args.itr):
        ...
        for epoch in range(args.train_epochs):
            ...
            for i, (batch_x, batch_y, batch_time, batch_real_time, batch_demo, batch_mask) in tqdm(enumerate(train_loader)):
                    ...
                    if args.use_amp:
                        with accelerator.autocast():
                            if args.output_attention:
                                outputs = model(batch_x, batch_time, batch_real_time, batch_demo, batch_mask)[0]
                            else:
                                outputs = model(batch_x, batch_time, batch_real_time, batch_demo, batch_mask)
