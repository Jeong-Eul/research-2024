        ...
        for b in range(B):
            ...
            for n in range(N):
                ...
                prompt_batch = (
                    ...
                    f"Task Description: Your goal is to predict the missing values marked by missing based on the surrounding time points. Use your understanding of vital sign trends and patient history to provide a complete time series embedding."
                    ...
                    f"Missing values occurred at time points: {missing_time_points}, and these were replaced with embedding of missing."
                )
